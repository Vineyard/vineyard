...
# 
# Heavily based on "Gnome to Wine color scraper" by Endolith <endolith@gmail.com>
# available at http://gist.github.com/74192 
#
# endolith@gmail.com 2009-02-06
# 
# Which is based on script by KillerKiwi [Ubuntu Forums] October 29th, 2007
...
menubar.ensure_style()
menuitem.ensure_style()"""
...
winetemp = os.path.expanduser('~')
#f = NamedTemporaryFile(prefix = 'winecolors', suffix = '.reg', dir = winetemp, mode = 'w+')
f = open('{0}/winecolors2.reg'.format(winetemp), 'w')
f.write("""REGEDIT4
